...
- [ ] Remediation of remaining two Mojibake symbols:
  - [ ] Fix `ן¬©` to `﬩` (Hebrew plus sign) on line 1150 of TeacherDashboard.tsx
  - [ ] Fix `גœ•` to `✖` (X mark button) on line 1706 of TeacherDashboard.tsx
- [ ] Final E2E and compile check
