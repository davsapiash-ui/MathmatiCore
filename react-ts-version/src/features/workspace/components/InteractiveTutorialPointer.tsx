...
const TUTORIAL_STEPS = [
  { text: "ברוכים הבאים למעבדת החשיבה! אני סמן ההדרכה.", x: 50, y: 30 },
  { text: "זהו טור היחידות בלוח המחקר שלנו.", x: 80, y: 50 },
  { text: "וכאן ממוקם טור העשרות.", x: 60, y: 50 },
  { text: "כדי להתחיל בניסוי, גררו ציוד (בלוקים) מארגז הכלים שלמטה אל הלוח.", x: 50, y: 85 },
  { text: "קיבוץ: אם תאספו 10 יחידות, תוכלו לגרור אותן יחד לטור העשרות כדי לארוז אותן.", x: 70, y: 40 },
  { text: "פריטה: לחצו לחיצה כפולה על עשרת כדי לפרק אותה ל-10 יחידות.", x: 60, y: 60 },
  { text: "כדי למחוק, גררו בלוק אל פח המחזור שבצד.", x: 15, y: 85 },
  { text: "זהו! קדימה, גררו כמה בלוקים ללוח והתנסו בעצמכם.", x: 50, y: 75 },
];
