...
const TUTORIAL_STEPS = [
  ...
  { text: "קיבוץ: אם תגררו יחידה אחת מתוך 10 יחידות אל טור העשרות, הן יתקבצו לעשרת אחת!", x: 50, y: 40 },
  { text: "פריטה: אם תגררו עשרת אל טור היחידות, היא תפרט חזרה ל-10 יחידות.", x: 50, y: 60 },
