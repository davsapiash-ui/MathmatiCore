...
const TUTORIAL_STEPS = [
  ...
  { text: "זהו טור היחידות בבית המספרים שלנו.", x: 42, y: 45 },
  { text: "וכאן ממוקם טור העשרות.", x: 28, y: 45 },
  { text: "כדי להתחיל בניסוי, גררו פריטים מארגז הכלים שלמטה אל הלוח.", x: 40, y: 85 },
  { text: "קיבוץ: אם יש לכם 10 יחידות או יותר, גררו אחת מהן לטור העשרות כדי לקבץ אותן לעשרת.", x: 28, y: 55 },
  { text: "פריטה: גררו עשרת אחת לטור היחידות כדי לפרוט אותה ל-10 יחידות.", x: 28, y: 55 },
  { text: "כדי למחוק, גררו פריט אל פח האשפה שבצד.", x: 5, y: 85 },
