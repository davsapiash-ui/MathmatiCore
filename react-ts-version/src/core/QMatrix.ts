...
export const TASKS: QMatrixTask[] = [
  ...
  },
  {
    ...
    backwardDiagnosis: {
      ...
      probeB: 3,
      probeAnswer: 7,
      probeInstructionHe: "בואו נדגום תרגיל קטן יותר כדי לכייל את החשיבה: כמה הם 4 ועוד 3?",
  ...
  },
  {
    ...
    backwardDiagnosis: {
      ...
      probeAnswer: 43,
      asdProbeAnswer: 11,
      probeInstructionHe: "בואו נבדוק חיסור נקי ללא פריטה: כמה הם 55 פחות 12?",
      graphicOrganizerASD: true,
    },
  },
  {
    ...
    backwardDiagnosis: {
      ...
      asdProbeAnswer: 2,
      asdProbeB: 3,
      probeInstructionHe: "בואו נבחן תבנית קטנה יותר: כמה צריך לחסר מ-10 כדי לקבל 7?",
    }
  },
  {
    ...
    backwardDiagnosis: {
      ...
      asdProbeAnswer: 2,
      asdProbeB: 5,
      probeInstructionHe: "בואו נבחן תבנית קטנה יותר: כמה צריך לחבר ל-7 כדי לקבל 10?",
    }
  }
];
