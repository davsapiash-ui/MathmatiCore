...
const S6_BORROW_PHRASE: Record<number, string> = {
  ...
  1: ' פרקו פעם אחת ובדקו את הכמויות בלוח בית המספרים.',
  2: ' כאן דרושה פריטה כפולה: פרקו פעמיים, זו אחרי זו, ובדקו את הכמויות בלוח בית המספרים.',
  3: ' כאן דרושה פריטה משולשת: פרקו שלוש פעמים, זו אחרי זו, ובדקו את הכמויות בלוח בית המספרים.',
};
