...
const S6_BORROW_PHRASE: Record<number, string> = {
  ...
  1: ' פרקו פעם אחת ועדכנו את הכמויות בלוח בית המספרים.',
  2: ' כאן דרושה פריטה כפולה: פרקו פעמיים, זו אחרי זו, ועדכנו את הכמויות בלוח בית המספרים.',
  3: ' כאן דרושה פריטה משולשת: פרקו שלוש פעמים, זו אחרי זו, ועדכנו את הכמויות בלוח בית המספרים.',
};
