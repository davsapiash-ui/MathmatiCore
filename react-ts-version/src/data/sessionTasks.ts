...
export const SESSION3_TASKS: SessionTask[] = [
  {
    ...
    instructionHe: 'בואו נחבר: 146 + 235. כאשר נאספים 10 פריטים בטור, לחצו על כפתור "הקבץ (10)" שבראש הטור או גררו אותם שמאלה!',
    requiresGrouping: true,
  ...
  },
  {
    ...
    instructionHe: 'בואו נחבר: 257 + 124. בנו את המספרים בטבלה, ובצעו קיבוץ באמצעות כפתור "הקבץ (10)" או בגרירה שמאלה.',
    requiresGrouping: true,
    targetNode: 'regrouping_fluency',
  },
  {
    ...
    instructionHe: 'פתרו: 138 + 245. מה קורה כשיש לנו 8 יחידות ועוד 5 יחידות? קבצו 10 יחידות לעשרת אחת בעזרת כפתור "הקבץ (10)" או בגרירה.',
    requiresGrouping: true,
    targetNode: 'regrouping_fluency',
  },
  {
    ...
    instructionHe: 'פתרו: 356 + 182. מה קורה כשמחברים 5 עשרות עם 8 עשרות? קבצו 10 עשרות למאה אחת בעזרת כפתור "הקבץ (10)" שבראש הטור.',
    requiresGrouping: true,
    targetNode: 'regrouping_fluency',
  },
  {
...
export const SESSION5_TASKS: SessionTask[] = [
  ...
  },
  {
    ...
    instructionHe: 'פתרו: 6,350 - 2,480. לחצו על קוביית המאה כדי לפרוט אותה ל-10 עשרות (או גררו אותה לטור העשרות) כדי לחסר.',
    requiresUngrouping: true,
    targetNode: 'regrouping_fluency',
  },
  {
    ...
    instructionHe: 'פתרו: 4,120 - 1,950. פרטו אלפים ומאות בלחיצה ישירה על הקוביות בלוח או בגרירתן ימינה.',
    requiresUngrouping: true,
    targetNode: 'regrouping_fluency',
  },
  {
...
export const SESSION6_TASKS: SessionTask[] = [
  {
    ...
    instructionHe: 'בנו בלוח את המספר 6,200 והחסירו ממנו 3,500. פרטו אלף אחד למאות בלחיצה על קוביית האלף או בגרירתה לטור המאות.',
    requiresUngrouping: true,
...
export const SESSION7_TASKS: SessionTask[] = [
  ...
  },
  {
    ...
    instructionHe: 'בנו 8,120 והחסירו 4,560. בצעו פריטה כפולה בלחיצה על קוביות האלפים והמאות בלוח (או בגרירתן ימינה).',
    requiresUngrouping: true,
    targetNode: 'relational_thinking',
  },
  {
  ...
  },
  {
    ...
    instructionHe: 'פרקו 1 מאה ל-10 עשרות (בלחיצה על קוביית המאה או בגרירתה לטור העשרות). בדקו: האם הכמות הכוללת בלוח השתנתה או שרק הייצוג השתנה?',
    requiresUngrouping: true,
    targetNode: 'relational_thinking',
  },
  {
