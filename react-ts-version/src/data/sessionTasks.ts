...
export const SESSION1_TASKS: SessionTask[] = [
  // 1. Guided Tour (Interactive Pointer)
  {
    id: 's1_guided_tour',
    type: 'session1_intro',
    titleHe: 'הדרכה אינטראקטיבית: הכרת המערכת',
    instructionHe: 'צפו בהדגמה המופיעה כעת על המסך. הסמן האוטומטי יראה לכם כיצד לגרור בלוקים, כיצד לבצע **קיבוץ** (איגוד של 10 יחידות לעשרת אחת על ידי גרירתן לטור העשרות), כיצד לבצע **פריטה** (פירוק עשרת חזרה ל-10 יחידות על ידי גרירתה לטור היחידות), וכיצד למחוק בלוקים. ניתן לדלג על ההדרכה בעזרת הכפתור למעלה.',
  ...
  // 2. Controlled Sandbox (Friction built-in)
  {
    ...
    instructionHe: 'כדי לקבל את "רישיון המעבדה", עליכם להוכיח שליטה בכלים: גררו לפחות 5 בלוקים ללוח, ולאחר מכן מחקו לפחות בלוק אחד (על ידי גרירה החוצה או לחיצה על פח המחזור). כפתור "התקדם" ייפתח רק לאחר שתשלימו משימה זו.',
    correctAnswer: 'proceed_any',
    scaffoldLevel: 0,
  },
  // 3. License Proof (Build and type)
  {
    ...
    titleHe: 'מבחן הרישיון: בנייה מדוייקת',
    instructionHe: 'בנו בטבלה את המספר 42 במדויק. לאחר מכן, הקלידו את המספר בתיבת התשובה שלמטה ולחצו על "בדיקה".',
    hintHe: 'ודאו ששמתם את העשרות בטור העשרות ואת היחידות בטור היחידות.',
    scaffoldLevel: 1,
  },
  // 4. Number Line Tool Practice
  {
    ...
    instructionHe: 'כלי נוסף במעבדה הוא ישר המספרים. גררו את החץ למקום שבו נמצא המספר 60 על הקו ולחצו בדיקה.',
    numberA: 60, // target
    scaffoldLevel: 0,
  },
  // 8. Math Refresh 1
