...
export const SESSION1_TASKS: SessionTask[] = [
  ...
  // 9. Math Refresh 2
  {
    ...
    instructionHe: 'בנו בבית המספרים 385 ו-152 וחברו אותם. כאשר יש לכם יותר מ-9 בלוקים בטור, תצטרכו להמיר אותם! (למשל: גררו 10 יחידות אל טור העשרות כדי לקבץ אותן לעשרת אחת).',
