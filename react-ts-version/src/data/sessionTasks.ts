...
export const SESSION1_TASKS: SessionTask[] = [
  // 1. Guided Tour (Interactive Pointer)
  {
    ...
    instructionHe: 'צפו בהדגמה על המסך. סמן המעבדה יראה לכם כיצד לגרור ציוד (בלוקים), כיצד **לקבץ** (למשל לאגד 10 יחידות לעשרת אחת), כיצד **לפרוט** (לפרק עשרת ל-10 יחידות), וכיצד לזרוק לפח המחזור. ניתן לדלג על התדריך בעזרת הכפתור למעלה.',
  ...
  // 2. Controlled Sandbox (Friction built-in)
  {
    ...
    instructionHe: 'כדי לקבל את רישיון החוקר שלכם, הראו שאתם שולטים בציוד המעבדה: גררו לפחות 5 בלוקים ללוח, ולאחר מכן מחקו לפחות בלוק אחד (על ידי גרירה החוצה או לחיצה על פח המחזור). מערכת "התקדם" תופעל רק לאחר מכן.',
    correctAnswer: 'proceed_any',
    scaffoldLevel: 0,
  },
