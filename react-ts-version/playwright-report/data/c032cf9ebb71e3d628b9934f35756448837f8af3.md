...
- Name: regrouping.spec.ts >> Regrouping State Mechanics >> verify no auto-regrouping and verify manual regrouping
  ...
  - generic [ref=e3]:
    - navigation [ref=e4]:
      ...
      - generic [ref=e19]:
        ...
        - button "הסתר לוח מוחשי" [ref=e22] [cursor=pointer]:
          - generic [ref=e23]: 🧮
          - generic [ref=e24]: הסתר לוח מוחשי
    ...
    - main [ref=e35]:
      - generic [ref=e38]:
        ...
        - generic [ref=e42]:
          - paragraph [ref=e43]: "כדי לקבל את רישיון החוקר שלכם, הראו שאתם שולטים בציוד המעבדה: גררו לפחות 5 פריטים ללוח, ולאחר מכן מחקו לפחות פריט אחד (על ידי גרירה החוצה או לחיצה על פח המחזור). מערכת \"התקדם\" תופעל רק לאחר מכן."
