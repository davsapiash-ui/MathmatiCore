...
**עמעום והיעלמות (מסמך 05, החלטת בעל המוצר 6 בספטמבר 2026):** הלוח נטען באנימציית עמעום רכה של בדיוק 2.5 שניות, ונעלם מעצמו בדיוק 3 שניות לאחר קלט מוצלח של ספרה נכונה על ידי הלומד (בשורת התוצאה, בעיגולי הזיכרון או במספרי התרגיל), כדי למנוע עומס חזותי אצל לומדים על הרצף האוטיסטי. ספרה שגויה אינה מעלימה את הלוח. הלומד יכול גם לסגור אותו ידנית.
