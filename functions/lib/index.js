...
exports.generateSocraticHint = (0, https_1.onCall)(async (request) => {
    ...
    if (!counts || !currentTask || !targetNode) {
        throw new https_1.HttpsError("invalid-argument", "Missing required fields: counts, currentTask, targetNode");
    }
    try {
...
Recent Trace Data: Undos=${(traceData === null || traceData === void 0 ? void 0 : traceData.undo_clicks) || 0}, Hesitations=${(traceData === null || traceData === void 0 ? void 0 : traceData.hesitation_events) || 0}
`;
        ...
        throw new https_1.HttpsError("internal", "Failed to generate hint.");
    }
});
